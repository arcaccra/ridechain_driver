abstract class Media {
  ...
  static const revToyota = "$_images/toyota_rev.png";
  ...
  static const check = "$_svgs/check.svg";
  static const upload = "$_svgs/upload.svg";
  static const document = "$_svgs/document.svg";
  static const camera = "$_svgs/photo.svg";
